...
Notice that equation (2) in the paper has a typo, $\pi_k$ was missing. However, there is no problem in the derivation of the latter algorithm, and the typo does not affect the simulation and real data results. The correct form of equation (2) in the paper is:
